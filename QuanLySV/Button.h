...
void DSSV1LTC(string str2, string str3, string str4, string str5, string str6, string str7) {
    ...
    outtextxy((550 + 700) / 2 - textwidth(convertStringToChar(khoa)) / 2, (160 + 170) / 2 - textheight(convertStringToChar(khoa)) / 2, convertStringToChar(khoa));
    outtextxy((750 + 850) / 2 - textwidth(convertStringToChar(HK)) / 2, (160 + 170) / 2 - textheight(convertStringToChar(HK)) / 2, convertStringToChar(HK));
    outtextxy((900 + 1000) / 2 - textwidth(convertStringToChar(nhom)) / 2, (160 + 170) / 2 - textheight(convertStringToChar(nhom)) / 2, convertStringToChar(nhom));
}
